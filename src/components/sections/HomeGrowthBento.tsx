...
function TileShell({
  ...
  return (
    <motion.div
      ...
      className={`flex flex-col justify-between rounded-3xl border border-white/10 bg-zinc-950 p-6 transition-colors hover:border-[#00b4ff]/25 hover:bg-zinc-900/80 md:p-8 ${className}`}
    >
      {children}
    </motion.div>
  );
...
export function HomeGrowthBento() {
  ...
  return (
    <section className="bg-[#07070f] py-24" aria-labelledby="home-bento-heading">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mb-14 md:mb-16">
          ...
          >
            <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-16 bg-gradient-to-r from-[#07070f] to-transparent md:w-24" />
            <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-16 bg-gradient-to-l from-[#07070f] to-transparent md:w-24" />
