...
export function Testimonials() {
  ...
  }, [items.length, reduceMotion, locale]);
      ...
      >
        ...
        <div className="flex shrink-0 items-center gap-2">
          <motion.button
            ...
            onClick={prev}
            whileTap={{ scale: 0.96 }}
            className="glass-hover-glow inline-flex h-11 w-11 items-center justify-center rounded-xl border border-[rgba(0,191,255,0.18)] bg-[rgba(15,15,35,0.65)] text-white shadow-[0_0_20px_rgba(0,191,255,0.08)] backdrop-blur-md transition hover:border-[rgba(0,191,255,0.35)]"
          >
